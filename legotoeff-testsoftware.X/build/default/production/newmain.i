...
# 791 "./mcc_generated_files/tmr4.h"
...
# 1 "./inc/legotoeff_loopdelay.h" 1
# 58 "./inc/legotoeff_loopdelay.h"
...
# 1 "./inc/legotoeff_helpers.h" 1
# 78 "./inc/legotoeff_helpers.h"
...
# 1 "./inc/legotoeff_lcddriver.h" 1
# 43 "./inc/legotoeff_lcddriver.h"
# 1 "./inc/legotoeff_helpers.h" 1
# 78 "./inc/legotoeff_helpers.h"
void DelayMS(uint16_t timeMS);
...
uint8_t BitNumb(uint8_t value);
# 44 "./inc/legotoeff_lcddriver.h" 2
# 98 "./inc/legotoeff_lcddriver.h"
...
# 1 "./inc/legotoeff_mux.h" 1
# 33 "./inc/legotoeff_mux.h"
...
uint16_t loopdelayInitTimeMS = 100;
...
void main(void)
{
    ...
    TMR6_SetInterruptHandler(LOOPDELAY_TimerISR);
    rgbSensorInit();
    muxSetChannel(4);
    I2C1_Write1ByteRegister(0x40,0xE8,0x00);
    LCD_Init();
    ...
    while (1)
    {
        ...
        switch(testState)
        {
            ...
            case I2CTEST:
                delay3sCounter++;
                if(delay3sCounter==(3000/loopdelayInitTimeMS))
                {
                    i2cCurrentSensor++;
                ...
                switch(i2cCurrentSensor)
                {
                    ...
                    case 3:
                        ...
                        rgbBlueData = rgbReadColor(i2cCurrentSensor,RGB_COLORS_BLUE);
                        ...
                        break;
                    case 4:
                        distancesensorData = distancesensorReadDistance();
                        LCD_Clear();
                        if(distancesensorData<50){
                        printf("Infrared:\n %u cm",distancesensorData);
                        }
                        else{
                            printf("Infrared\nOut Of Range!");
                        }
            ...
            case PWMTEST:
                ...
                if(delay3sCounter==(3000/loopdelayInitTimeMS))
                {
                    ...
                    {
                        case DC_20_t:
                            PWM3_LoadDutyValue(0x32);
                            PWM4_LoadDutyValue(0x32);
                            LCD_Clear();
                            printf("PWM Duty\nCycle: 20");
                            LATEbits.LATE2=1;LCD_SendByte(0b00100101);LATEbits.LATE2=0;
                            currentDutyCycles = DC_33_t;
                            break;
                        case DC_33_t:
                            PWM3_LoadDutyValue(0x56);
                            PWM4_LoadDutyValue(0x56);
                            LCD_Clear();
                            printf("PWM Duty\nCycle: 33");
                            LATEbits.LATE2=1;LCD_SendByte(0b00100101);LATEbits.LATE2=0;
                            currentDutyCycles = DC_50_t;
                            break;
                        case DC_50_t:
                            PWM3_LoadDutyValue(0x7F);
                            PWM4_LoadDutyValue(0x7F);
                            LCD_Clear();
                            printf("PWM Duty\nCycle: 50");
                            LATEbits.LATE2=1;LCD_SendByte(0b00100101);LATEbits.LATE2=0;
                            currentDutyCycles = DC_60_t;
                            break;
                        case DC_60_t:
                            PWM3_LoadDutyValue(0x99);
                            PWM4_LoadDutyValue(0x99);
                            LCD_Clear();
                            printf("PWM Duty\nCycle: 60");
                            LATEbits.LATE2=1;LCD_SendByte(0b00100101);LATEbits.LATE2=0;
                            currentDutyCycles = DC_66_t;
                            break;
                        case DC_66_t:
                            PWM3_LoadDutyValue(0xA8);
                            PWM4_LoadDutyValue(0xA8);
                            LCD_Clear();
                            printf("PWM Duty\nCycle: 66");
                            LATEbits.LATE2=1;LCD_SendByte(0b00100101);LATEbits.LATE2=0;
                            currentDutyCycles = DC_100_t;
                            break;
                        case DC_100_t:
                            PWM3_LoadDutyValue(0xFF);
                            PWM4_LoadDutyValue(0xFF);
                            LCD_Clear();
                            printf("PWM Duty\nCycle: 100");
                            LATEbits.LATE2=1;LCD_SendByte(0b00100101);LATEbits.LATE2=0;
                            currentDutyCycles = DC_20_t;
                            break;
                        default:
                            break;
                    }
            ...
            case MDRIVER1TEST:
                ...
                if(delay3sCounter==(3000/loopdelayInitTimeMS))
                {
                    ...
                    LCD_Clear();
                    printf("M1IN1:%i M1IN2:%i",LATAbits.LATA1,LATAbits.LATA2);
                    if(LATAbits.LATA1 == 1 && LATAbits.LATA2 == 0){
                        printf("\nVorwärts");
                    }
                    if(LATAbits.LATA1 == 0 && LATAbits.LATA2 == 1){
                        printf("\nRückwärts");
                    }
                    delay3sCounter = 0;
                }

                if(!PORTBbits.RB3 && TASTER1Flag)
                {
                    testState = I2CTEST;
                    LATAbits.LATA3 = 0;
                    LATAbits.LATA7 = 0;
            ...
            case MDRIVER2TEST:
                ...
                if(delay3sCounter==(3000/loopdelayInitTimeMS))
                {
                    ...
                    LCD_Clear();
                    printf("M2IN1:%i M2IN2:%i",LATAbits.LATA5,LATAbits.LATA6);
                    if(LATAbits.LATA5 == 1 && LATAbits.LATA6 == 0){
                        printf("\nVorwärts");
                    }
                    if(LATAbits.LATA5 == 0 && LATAbits.LATA6 == 1){
                        printf("\nRückwärts");
                    }
                    delay3sCounter = 0;
                }

                if(!PORTBbits.RB2 && TASTER2Flag)
                {
                    testState = I2CTEST;
                    LATAbits.LATA3 = 0;
                    LATAbits.LATA7 = 0;
...
uint8_t distancesensorReadDistance(void)
{
    ...
    upperData = I2C1_Read1ByteRegister(0x40,0x5E);
    data = (upperData / 4);
...
void rgbSensorInit(void)
{
    ...
    for(i=1;i<4;i++)
    {
        slaveAddress = muxSetChannel(i);

        I2C1_Write1ByteRegister(slaveAddress,0x80,0b00000011);
        _delay((unsigned long)((3)*(64000000/4000.0)));
        I2C1_Write1ByteRegister(slaveAddress,0x81,0xFF);
        I2C1_Write1ByteRegister(slaveAddress,0x8F,0x00000011);
    }
}
# 408 "newmain.c"
uint8_t rgbReadColor(uint8_t channel, type_rgb_colors rgbColor)
{
    ...
    switch(rgbColor)
    {
        case RGB_COLORS_CLEAR:
            readData = I2C1_Read1ByteRegister(0x29,0x94);
            break;
        case RGB_COLORS_RED:
            readData = I2C1_Read1ByteRegister(0x29,0x96);
            break;
        case RGB_COLORS_GREEN:
            readData = I2C1_Read1ByteRegister(0x29,0x98);
            break;
        case RGB_COLORS_BLUE:
            readData = I2C1_Read1ByteRegister(0x29,0x9A);
            break;
        default:
            break;
    }
