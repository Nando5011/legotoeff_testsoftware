...
# 2 "<built-in>" 2
# 1 "src/legotoeff_lcddriver.c" 2
# 39 "src/legotoeff_lcddriver.c"
# 1 "src/../inc/legotoeff_lcddriver.h" 1
# 41 "src/../inc/legotoeff_lcddriver.h"
...
# 42 "src/../inc/legotoeff_lcddriver.h" 2
...
# 43 "src/../inc/legotoeff_lcddriver.h" 2
# 1 "src/../inc/legotoeff_helpers.h" 1
# 78 "src/../inc/legotoeff_helpers.h"
...
# 44 "src/../inc/legotoeff_lcddriver.h" 2
# 98 "src/../inc/legotoeff_lcddriver.h"
...
void LCD_Init(void);
# 40 "src/legotoeff_lcddriver.c" 2



static uint8_t LCD_GetSpecChar(uint8_t ch);
# 55 "src/legotoeff_lcddriver.c"
void LCD_SendByte(uint8_t value)
{
    LATEbits.LATE1=1;
    LATD = value;
...
void LCD_Putc(uint8_t ch)
{
    switch (ch)
    {
        ...
        default:
            LATEbits.LATE2=1;LCD_SendByte(LCD_GetSpecChar(ch));LATEbits.LATE2=0;
    }
}
